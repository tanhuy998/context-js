...
var _require = require('reflectype/src/'),
  implement = _require.implement;
var ITest = /*#__PURE__*/function (_Interface) {
  _inherits(ITest, _Interface);
  var _super = _createSuper(ITest);
  function ITest() {
    _classCallCheck(this, ITest);
...
new (function () {
  ...
  var _applyDecs2203R$c = _slicedToArray(_applyDecs2203R(A, [], [_dec]).c, 2);
  ...
  function _class2() {
    ...
    (_this = _super2.call(this, _A), _defineProperty(_assertThisInitialized(_this), "count", 0)), _initClass();
    return _this;
  }
  return _createClass(_class2);
}(_identity))();
var Scope = require('../../src/dependenies/component/scope.js');
components.bindScope(_A, _A);
components.bindScope(ITest, _A);
var scope = components.get(Scope);
var obj = components.get(ITest, scope);
var obj2 = components.get(_A);
var obj3 = components.get(_A, scope);
var obj4 = components.get(ITest, scope);
console.log(obj); // 1
