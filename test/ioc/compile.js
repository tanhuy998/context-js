...
var _require2 = require('reflectype/src/interface/interface'),
  implement = _require2.implement;
var _require3 = require('reflectype/src/index.js'),
  type = _require3.type,
  paramsType = _require3.paramsType;
...
_dec = paramsType(Bike);
var A = /*#__PURE__*/function () {
  function A() {
    _classCallCheck(this, A);
    _defineProperty(this, "vehicleA", void 0);
    _initProto(this);
  }
  _createClass(A, [{
    key: CONSTRUCTOR,
...
var _applyDecs2203R$e = _slicedToArray(_applyDecs2203R(A, [[_dec, 2, CONSTRUCTOR]], []).e, 1);
_initProto = _applyDecs2203R$e[0];
_dec2 = paramsType(Car);
var B = /*#__PURE__*/function (_A) {
  ...
  function B() {
    ...
    _defineProperty(_assertThisInitialized(_this), "vehicleB", void 0);
    _initProto2(_assertThisInitialized(_this));
    return _this;
  }
  _createClass(B, [{
    key: CONSTRUCTOR,
...
var _applyDecs2203R$e2 = _slicedToArray(_applyDecs2203R(B, [[_dec2, 2, CONSTRUCTOR]], []).e, 1);
_initProto2 = _applyDecs2203R$e2[0];
