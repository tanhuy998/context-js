...
var _dec, _init_vehicleA, _dec2, _init_drive, _initProto, _dec3, _init_vehicleA2, _dec4, _initProto2;
...
var ComponentManager = require('../../src/dependenies/component/componentManager.js');
...
var implement = require('reflectype/src/decorators/implement.js');
var _require2 = require('reflectype/src/decorators/index.js'),
  type = _require2.type,
  paramsType = _require2.paramsType;
var autowired = require('../../decorators/autowired.js');
...
var _applyDecs2203R$e = _slicedToArray(_applyDecs2203R(A, [[[autowired, _dec], 1, "vehicleA"], [_dec2, 1, "drive"]], []).e, 3);
_init_vehicleA = _applyDecs2203R$e[0];
_init_drive = _applyDecs2203R$e[1];
_initProto = _applyDecs2203R$e[2];
_dec3 = type(Car);
_dec4 = paramsType(Car);
...
var _applyDecs2203R$e2 = _slicedToArray(_applyDecs2203R(B, [[[autowired, _dec3], 1, "vehicleA"], [_dec4, 2, CONSTRUCTOR]], []).e, 2);
...
var obj = components.get(B);
var objA = components.get(A);
